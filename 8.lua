...
-- Инициализация дисплея и сцены C3D
local display = c3d.display(monitor)
...
-- Пол (3D Plane)
local floor = c3d.plane(12, 12)
floor.pos = {0, 0, 0}
floor.color = colors.green
scene:add(floor)

-- 4 Столба (3D Cubes) на равном расстоянии
...
local function update(dt)
    -- Вращение (A - вправо, D - влево по твоим настройкам)
